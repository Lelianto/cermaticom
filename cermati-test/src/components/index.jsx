...
class Upperheader extends Component {
	...
	render() {
		...
		return (
			<React.Fragment>
				<div className={className} style={{backgroundColor:'#e5e5e5', zIndex: 500}}>
					<div className='row'>
						<div className='col-lg-3'></div>
						<div className='col-lg-4 text-left mt-20 mb-20 ml-20'>
						...
						<div className='col-lg-1 pt-35 text-left'>
